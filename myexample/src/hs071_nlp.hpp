...
//
// $Id: HS071_NLP.hpp 2242 2013-04-24 19:26:30Z stefan $
//
// Authors:  Carl Laird, Andreas Waechter     IBM    2004-08-13

#ifndef __IPHS071_NLP_HPP__
#define __IPHS071_NLP_HPP__
...
namespace Ipopt
{
  ...
  private:
    ...
    /** Method called by HS071_NLP to prepare the asl for the suffixes */
    void PrepareAmplForSuffixes(ASL_pfgh* asl);

    /** Method called by HS071_NLP to retrieve the suffixes from asl */
    //    void RetrieveSuffixesFromAmpl(ASL_pfgh* asl);

    friend class HS071_NLP;
  };
  ...
  public:
    ...
    //@{
    /** Constructor. */
    HS071_NLP(const SmartPtr<const Journalist>& jnlst,
